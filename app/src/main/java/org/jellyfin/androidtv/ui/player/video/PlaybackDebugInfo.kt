...
private fun buildPlaybackDebugInfo(
	...
	appendPart(stream.conversionMethod.playMethodLabel())
	appendPart(videoTrack.videoSummary())
	appendPart(audioTrack.audioSummary(selectedAudio))
	appendPart(selectedSubtitle.subtitleSummary())
}
...
private fun MediaConversionMethod.playMethodLabel() = when (this) {
